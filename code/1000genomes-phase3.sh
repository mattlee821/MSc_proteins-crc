...
DIRECTORY_RAW=/Users/faye/Desktop/001_projects/MSc_proteins-crc/data/references/1000genomes/phase3/raw/
DIRECTORY_PROCESSED=/Users/faye/Desktop/001_projects/MSc_proteins-crc/data/references/1000genomes/phase3/processed/
...
wget https://www.dropbox.com/s/0omyj2tyu7jmmw9/deg1_phase3.king.cutoff.out.id?dl=1 #no match file, so can't rename
wget https://www.dropbox.com/s/zj8d14vv9mp6x3c/deg2_phase3.king.cutoff.out.id?dl=1 #no match file, so can't rename
...
/Users/faye/Desktop/001_projects/MSc_proteins-crc/code/plink2 --zst-decompress ${DIRECTORY_RAW}all_phase3.pgen.zst > ${DIRECTORY_PROCESSED}all_phase3.pgen
/Users/faye/Desktop/001_projects/MSc_proteins-crc/code/plink2 --zst-decompress ${DIRECTORY_RAW}all_phase3.pvar.zst > ${DIRECTORY_PROCESSED}all_phase3.pvar
...
/Users/faye/Desktop/001_projects/MSc_proteins-crc/code/plink2 --pfile all_phase3 --remove ${DIRECTORY_RAW}deg2_phase3.king.cutoff.out.id --make-pgen
...
for POPULATION in "${SUPER_POPULATION[@]}"; do
    mkdir -p "${POPULATION}"
    echo "." > exclude.snps
    /Users/faye/Desktop/001_projects/MSc_proteins-crc/code/plink2 --make-bed --out "${POPULATION}/${POPULATION}" \
...
SUPER_POPULATION=("AFR" "ALL" "AMR" "EAS" "EUR" "SAS")
for POPULATION in "${SUPER_POPULATION[@]}"; do
    /Users/faye/Desktop/001_projects/MSc_proteins-crc/code/plink1.9/plink --bfile "${POPULATION}/${POPULATION}" \
...
SUPER_POPULATION=("AFR" "ALL" "AMR" "EAS" "EUR" "SAS")
for POPULATION in "${SUPER_POPULATION[@]}"; do
	/Users/faye/Desktop/001_projects/MSc_proteins-crc/code/ldak5.2.mac --calc-stats "${POPULATION}/"stats --bfile "${POPULATION}/${POPULATION}"
done
