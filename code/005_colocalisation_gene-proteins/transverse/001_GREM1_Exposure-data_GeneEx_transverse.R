...
write.table(data_protein_window, "analysis/005_colocalisation_gene-proteins/transverse/Exposure_GREM1-gene_transverse_window_coloc.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
data_SNPlist <- data_protein_window %>%
  ...
  unique() %>%
  as.data.frame()
write.table(data_SNPlist, "analysis/005_colocalisation_gene-proteins/transverse/Exposure_GREM1-gene_transverse_SNPlist.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
