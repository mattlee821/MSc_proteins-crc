...
data_SNPlist <- fread("analysis/005_colocalisation_gene-proteins/transverse/Exposure_GREM1-gene_transverse_SNPlist.txt" )
head(data_SNPlist)
...
head(data_outcome)
write.table(data_outcome, "analysis/005_colocalisation_gene-proteins/transverse/Outcome_GREM1-protein_transverse_coloc.txt", sep="\t",row.names = FALSE, quote = FALSE, col.names = TRUE)
