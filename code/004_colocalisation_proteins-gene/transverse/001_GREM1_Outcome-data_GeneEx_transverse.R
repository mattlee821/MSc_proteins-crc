#004-001_colocalisation_proteins-gene
...
data_SNPlist <- fread("analysis/004_colocalisation_proteins-gene/transverse/Exposure_GREM1-protein-SNPlist.txt" )
head(data_SNPlist)
...
head(data_outcome)
write.table(data_outcome, "analysis/004_colocalisation_proteins-gene/transverse/Outcome_GREM1-gene_transverse_coloc.txt", sep="\t",row.names = FALSE, quote = FALSE, col.names = TRUE)
