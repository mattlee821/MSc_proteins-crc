...
write.table(data_protein_window, "analysis/004_colocalisation_proteins-gene/transverse/Exposure_GREM1-protein-window-coloc.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
data_protein_SNPlist <- data_protein_window %>%
  ...
  unique() %>%
  as.data.frame()
write.table(data_protein_SNPlist, "analysis/004_colocalisation_proteins-gene/transverse/Exposure_GREM1-protein-SNPlist.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
