...
data_SNPlist <- fread("analysis/006_colocalisation_gene-CRC/sigmoid/Exposure_GREM1-gene_sigmoid_SNPlist.txt" )
head(data_SNPlist)
...
head(data_outcome)
write.table(data_outcome, "analysis/006_colocalisation_gene-CRC/sigmoid/Outcome_GREM1-CRC_sigmoid_coloc.txt", sep="\t",row.names = FALSE, quote = FALSE, col.names = TRUE)
