###MR - CRC and Gene Expression (Transverse)
rm(list=ls())
set.seed(821)
...
write.table(data_harmonise, "analysis/007_MR_CRC-gene/001_ENSG00000166923-10_transverse_data_harmonise_crc-gene.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
...
print(table_mr)
write.table(table_mr, "analysis/007_MR_CRC-gene/001_ENSG00000166923-10_transverse_table_mr_crc-gene.txt", sep="\t", row.names = FALSE, quote = FALSE, col.names = TRUE)
