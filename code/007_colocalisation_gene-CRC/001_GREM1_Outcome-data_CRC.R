...
data_protein_SNPlist <- fread("analysis/007_colocalisation_gene-CRC/Exposure_GREM1-gene_SNPlist.txt" )
...
head(data_crc_coloc)
write.table(data_crc_coloc, "analysis/007_colocalisation_gene-CRC/Outcome_GREM1-CRC_coloc.txt", sep="\t",row.names = FALSE, quote = FALSE, col.names = TRUE)
